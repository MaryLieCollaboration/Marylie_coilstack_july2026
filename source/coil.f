...
ctm
       write(6,16) (pa(i),i=1,5)
  16   format('  coil: ',5f12.5)
       write(6,17) (pa(i),i=6,11)
  17   format(' shape: ',6f10.4)
       it = nint(pa(5))
c
...
c
c If itype == -1 spacer.
c Note: spacer does not increase coil number
       if ( it .eq. -1 ) then
          if ( ncoil .eq. 0 ) then
            xldr = pa(1)
          else
...
c
      ...
      AAz(5,0)=-5*q*gn(1,4)/192 + 5*q*gn(3,2)/48
      AAx(4,1)=q*gs(2,3)/12 - q*gs(4,1)
      AAy(4,1)=-(q*gn(2,3))/24 + q*gn(4,1)/4
      AAz(4,1)=5*q*gs(1,4)/192 - 5*q*gs(3,2)/16
      AAx(3,2)=-3*q*gn(4,1)/2
      AAy(3,2)=q*gs(2,3)/12 - q*gs(4,1)
      AAz(3,2)=-5*q*gn(1,4)/96 - 5*q*gn(3,2)/24
      AAx(2,3)=q*gs(2,3)/12 + q*gs(4,1)
      AAy(2,3)=-3*q*gn(4,1)/2
      AAz(2,3)=5*q*gs(1,4)/96 - 5*q*gs(3,2)/24
      AAx(1,4)=q*gn(2,3)/24 + q*gn(4,1)/4
      AAy(1,4)=q*gs(2,3)/12 + q*gs(4,1)
      AAz(1,4)=-5*q*gn(1,4)/192 - 5*q*gn(3,2)/16
      AAy(0,5)=q*gn(2,3)/24 + q*gn(4,1)/4
      AAz(0,5)=5*q*gs(1,4)/192 + 5*q*gs(3,2)/48
      AAx(6,0)=q*gn(1,5)/192 - q*gn(3,3)/48
      AAz(6,0)=-(q*gn(2,4))/128 + 3*q*gn(4,2)/40
      AAx(5,1)=-(q*gs(1,5))/192 + q*gs(3,3)/16
      AAy(5,1)=q*gn(1,5)/192 - q*gn(3,3)/48
      AAz(5,1)=q*gs(2,4)/64 - 3*q*gs(4,2)/10
      AAx(4,2)=q*gn(1,5)/96 + q*gn(3,3)/24
      AAy(4,2)=-(q*gs(1,5))/192 + q*gs(3,3)/16
      AAz(4,2)=-(q*gn(2,4))/128 - 3*q*gn(4,2)/8
      AAx(3,3)=-(q*gs(1,5))/96 + q*gs(3,3)/24
      AAy(3,3)=q*gn(1,5)/96 + q*gn(3,3)/24
      AAz(3,3)=q*gs(2,4)/32
      AAx(2,4)=q*gn(1,5)/192 + q*gn(3,3)/16
      AAy(2,4)=-(q*gs(1,5))/96 + q*gs(3,3)/24
      AAz(2,4)=q*gn(2,4)/128 - 3*q*gn(4,2)/8
      AAx(1,5)=-(q*gs(1,5))/192 - q*gs(3,3)/48
      AAy(1,5)=q*gn(1,5)/192 + q*gn(3,3)/16
      AAz(1,5)=q*gs(2,4)/64 + 3*q*gs(4,2)/10
      AAy(0,6)=-(q*gs(1,5))/192 - q*gs(3,3)/48
      AAz(0,6)=q*gn(2,4)/128 + 3*q*gn(4,2)/40
      AAx(7,0)=q*gn(2,5)/768 - q*gn(4,3)/80
      AAz(7,0)=7*q*gn(1,6)/9216 - 7*q*gn(3,4)/1920
      AAx(6,1)=-(q*gs(2,5))/384 + q*gs(4,3)/20
      AAy(6,1)=q*gn(2,5)/768 - q*gn(4,3)/80
      AAz(6,1)=-7*q*gs(1,6)/9216 + 7*q*gs(3,4)/640
      AAx(5,2)=q*gn(2,5)/768 + q*gn(4,3)/16
      AAy(5,2)=-(q*gs(2,5))/384 + q*gs(4,3)/20
      AAz(5,2)=7*q*gn(1,6)/3072 + 7*q*gn(3,4)/1920
      AAx(4,3)=-(q*gs(2,5))/192
      AAy(4,3)=q*gn(2,5)/768 + q*gn(4,3)/16
      AAz(4,3)=-7*q*gs(1,6)/3072 + 7*q*gs(3,4)/384
      AAx(3,4)=-(q*gn(2,5))/768 + q*gn(4,3)/16
      AAy(3,4)=-(q*gs(2,5))/192
      AAz(3,4)=7*q*gn(1,6)/3072 + 7*q*gn(3,4)/384
      AAx(2,5)=-(q*gs(2,5))/384 - q*gs(4,3)/20
      AAy(2,5)=-(q*gn(2,5))/768 + q*gn(4,3)/16
      AAz(2,5)=-7*q*gs(1,6)/3072 + 7*q*gs(3,4)/1920
      AAx(1,6)=-(q*gn(2,5))/768 - q*gn(4,3)/80
      AAy(1,6)=-(q*gs(2,5))/384 - q*gs(4,3)/20
      AAz(1,6)=7*q*gn(1,6)/9216 + 7*q*gn(3,4)/640
      AAy(0,7)=-(q*gn(2,5))/768 - q*gn(4,3)/80
      AAz(0,7)=-7*q*gs(1,6)/9216 - 7*q*gs(3,4)/1920
      AAx(8,0)=-(q*gn(1,7))/9216 + q*gn(3,5)/1920
      AAz(8,0)=q*gn(2,6)/5760 - q*gn(4,4)/480
      AAx(7,1)=q*gs(1,7)/9216 - q*gs(3,5)/640
      AAy(7,1)=-(q*gn(1,7))/9216 + q*gn(3,5)/1920
      AAz(7,1)=-(q*gs(2,6))/2880 + q*gs(4,4)/120
      AAx(6,2)=-(q*gn(1,7))/3072 - q*gn(3,5)/1920
      AAy(6,2)=q*gs(1,7)/9216 - q*gs(3,5)/640
      AAz(6,2)=q*gn(2,6)/2880 + q*gn(4,4)/120
      AAx(5,3)=q*gs(1,7)/3072 - q*gs(3,5)/384
      AAy(5,3)=-(q*gn(1,7))/3072 - q*gn(3,5)/1920
      AAz(5,3)=-(q*gs(2,6))/960 + q*gs(4,4)/120
      AAx(4,4)=-(q*gn(1,7))/3072 - q*gn(3,5)/384
      AAy(4,4)=q*gs(1,7)/3072 - q*gs(3,5)/384
      AAz(4,4)=q*gn(4,4)/48
      AAx(3,5)=q*gs(1,7)/3072 - q*gs(3,5)/1920
      AAy(3,5)=-(q*gn(1,7))/3072 - q*gn(3,5)/384
      AAz(3,5)=-(q*gs(2,6))/960 - q*gs(4,4)/120
      AAx(2,6)=-(q*gn(1,7))/9216 - q*gn(3,5)/640
      AAy(2,6)=q*gs(1,7)/3072 - q*gs(3,5)/1920
      AAz(2,6)=-(q*gn(2,6))/2880 + q*gn(4,4)/120
      AAx(1,7)=q*gs(1,7)/9216 + q*gs(3,5)/1920
      AAy(1,7)=-(q*gn(1,7))/9216 - q*gn(3,5)/640
      AAz(1,7)=-(q*gs(2,6))/2880 - q*gs(4,4)/120
      AAy(0,8)=q*gs(1,7)/9216 + q*gs(3,5)/1920
      AAz(0,8)=-(q*gn(2,6))/5760 - q*gn(4,4)/480
      AAx(9,0)=-(q*gn(2,7))/46080 + q*gn(4,5)/3840
      AAz(9,0)=-(q*gn(1,8))/81920 + q*gn(3,6)/15360
      AAx(8,1)=q*gs(2,7)/23040 - q*gs(4,5)/960
      AAy(8,1)=-(q*gn(2,7))/46080 + q*gn(4,5)/3840
      AAz(8,1)=q*gs(1,8)/81920 - q*gs(3,6)/5120
      AAx(7,2)=-(q*gn(2,7))/23040 - q*gn(4,5)/960
      AAy(7,2)=q*gs(2,7)/23040 - q*gs(4,5)/960
      AAz(7,2)=-(q*gn(1,8))/20480
      AAx(6,3)=q*gs(2,7)/7680 - q*gs(4,5)/960
      AAy(6,3)=-(q*gn(2,7))/23040 - q*gn(4,5)/960
      AAz(6,3)=q*gs(1,8)/20480 - q*gs(3,6)/1920
      AAx(5,4)=-(q*gn(4,5))/384
      AAy(5,4)=q*gs(2,7)/7680 - q*gs(4,5)/960
      AAz(5,4)=-3*q*gn(1,8)/40960 - q*gn(3,6)/2560
      AAx(4,5)=q*gs(2,7)/7680 + q*gs(4,5)/960
      AAy(4,5)=-(q*gn(4,5))/384
      AAz(4,5)=3*q*gs(1,8)/40960 - q*gs(3,6)/2560
      AAx(3,6)=q*gn(2,7)/23040 - q*gn(4,5)/960
      AAy(3,6)=q*gs(2,7)/7680 + q*gs(4,5)/960
      AAz(3,6)=-(q*gn(1,8))/20480 - q*gn(3,6)/1920
      AAx(2,7)=q*gs(2,7)/23040 + q*gs(4,5)/960
      AAy(2,7)=q*gn(2,7)/23040 - q*gn(4,5)/960
      AAz(2,7)=q*gs(1,8)/20480
      AAx(1,8)=q*gn(2,7)/46080 + q*gn(4,5)/3840
      AAy(1,8)=q*gs(2,7)/23040 + q*gs(4,5)/960
      AAz(1,8)=-(q*gn(1,8))/81920 - q*gn(3,6)/5120
      AAy(0,9)=q*gn(2,7)/46080 + q*gn(4,5)/3840

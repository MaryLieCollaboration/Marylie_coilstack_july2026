...
c Compute and store t2*t1
      call concat(ta,tm,tta,ttm,tta,ttm)
...
c Calling arrays
      dimension fa(monoms),ga(monoms),ta(monoms)
      dimension fm(6,6),gm(6,6),tm(6,6),t2m(6,6)
c
c Local arrays
      dimension t1a(monoms),t2a(monoms)
      dimension t1m(6,6)
c
